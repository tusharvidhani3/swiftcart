...
export default function OrderCard({ order }) {
    ...
    return orderItems ? (
        <div className={styles.orderCard} onClick={() => navigate(`./summary/${orderId}`)}>
            <div className={styles.orderDetails}>
                ...
                <div className={`${styles.orderTotal} ${styles.orderField}`}><span>Total</span> <span className={styles.totalAmount}>₹ {totalAmount}</span></div>
