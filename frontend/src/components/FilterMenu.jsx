                    ...
                    <div className={styles.filters}>
                        ...
                        {(isMobile && selectedAttribute === 1 || !isMobile) && <div className={styles.categoryFilters}>
                            ...
                            <div className={styles.filterOption}>
                                <input type="checkbox" id="smartphones" checked={filters.categories.has("smartphones")} onChange={() => setFilters(filters => {
                        ...
                        {(isMobile && selectedAttribute === 2 || !isMobile) && <div className={styles.availabilityFilters}>
                            ...
                            <div className={styles.filterOption}>
                                <input type="checkbox" id="includeOutOfStock" checked={Boolean(filters.availability.includeOutOfStock)} onChange={() => setFilters(filters => ({ ...filters, availability: { ...filters.availability, includeOutOfStock: !filters.availability.includeOutOfStock } }))} />
